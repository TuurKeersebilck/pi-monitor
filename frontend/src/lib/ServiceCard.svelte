...
<style>
  ...
  .tag-running { background: rgba(52, 199, 89, 0.12); color: #34c759; }
  .tag-stopped { background: rgba(255, 59, 48, 0.1); color: #ff3b30; }
  .tag-uptime  { background: var(--pill); color: var(--text-2); }
  .tag-update  { background: rgba(255, 149, 0, 0.12); color: #ff9500; }
</style>
